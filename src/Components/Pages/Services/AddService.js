        ...
        fetch('http://localhost:5000/addService', {
            ...
            .then((data) => {
                ...
                if (data.acknowledged) {
                    ...
                    toast.success(`Service Successful Added, 'Name' = ${name}`, {
                        duration: 3000,
                        position: "top-center",
            ...
            <div className="w-11/12 mx-auto  p-8 space-y-3 rounded-xl bg-blue-600 text-white cus-svg-login ">
                ...
                <form
                    ...
                    <div className="space-y-1">
                        ...
                        <input type="text" name="description" id="description" placeholder="Description" className="w-full px-4 py-3 rounded-md outline-blue-700 bg-blue-100  text-black font-medium text-lg placeholder:text-blue-700 placeholder:font-medium placeholder:italic" required />

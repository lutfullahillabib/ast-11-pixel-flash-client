        ...
        <div>
            <>
                ...
                >
                    ...
                    <SwiperSlide>
                        <div
                            className="h-96 lg:h-[30rem] bg-cover bg-center bg-no-repeat text-white "
                            style={{
                        ...
                        >
                            <div className="bg-gradient-to-r from-black to-transparent w-full h-full  p-5 flex justify-center items-center">
